...
export class Enemy {
    constructor(x, y, minSpeed, maxSpeed, health, player) {
        this.x = x;
        this.y = y;
        this.radius = 15;
    ...
    update(player, deltaTime = 16.67) { // pass deltaTime if you have it
    ...
    spawnDrops(drops) {
        drops.push(new Emerald(this.x, this.y, "emerald"));
    }
}